...
const steps = [
  {
    ...
    description: 'Одберете го животниот настан за кој ви се потребни информации',
  },
  {
    icon: FileText,
...
const features = [
  {
    icon: Shield,
    title: 'Сигурност',
    description: 'Вашите податоци се заштитени со најсовремени безбедносни мерки',
  },
  {
    icon: Clock,
    title: 'Заштеда на време',
    description: 'Добијте сите потребни информации на едно место, брзо и едноставно',
  },
  {
    icon: Users,
    title: 'Поддршка',
        ...
        <section className="py-20 md:py-32 bg-gradient-to-b from-primary/5 to-background">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-6 text-balance">
              Дигитални јавни услуги на дофат
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 text-pretty">
              еУслуги ви помага да ги разберете и завршите административните процедури 
              поврзани со важни животни настани - брзо, едноставно и ефикасно.
            </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-xl mx-auto">
                Само неколку едноставни чекори до комплетна листа на потребни документи и процедури
              </p>
            </div>
            
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {steps.map((step, index) => (
                <Card key={index} className="relative bg-card border-border hover:border-primary/50 transition-colors">
                  <CardHeader>
        ...
        <section className="py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-xl mx-auto">
                Платформа дизајнирана да го поедностави пристапот до јавните услуги
              </p>
            </div>
        ...
        <section className="py-20 bg-primary">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-primary-foreground/80 max-w-xl mx-auto mb-8">
              Регистрирајте се денес и добијте пристап до сите функционалности на платформата
            </p>
            {!user && (
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
