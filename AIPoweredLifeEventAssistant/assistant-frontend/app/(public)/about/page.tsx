...
import { FileText, Target, Eye, Users, ArrowRight, CheckCircle, Shield, Zap, Heart } from 'lucide-react'
      ...
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-sm border-b border-border">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="/about" className="text-sm font-medium text-primary hover:text-primary transition-colors">
              За нас
            </Link>
          ...
          <div className="container mx-auto px-4 relative">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 text-balance leading-tight">
                Дигитализација на <span className="text-primary">јавните услуги</span>
              </h1>
              
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto text-pretty leading-relaxed">
                еУслуги е платформа создадена со цел да го поедностави пристапот до јавните услуги 
                и да им помогне на граѓаните да ги завршат административните процедури побрзо и поефикасно.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              <Card className="group relative overflow-hidden bg-gradient-to-br from-primary/5 to-primary/10 border-primary/20 hover:border-primary/40 transition-all duration-300">
                <CardContent className="p-8">
                  ...
                  <h2 className="text-2xl font-bold text-foreground mb-4">Наша мисија</h2>
                  <p className="text-muted-foreground leading-relaxed">
                    Да создадеме дигитална платформа која ќе им овозможи на граѓаните лесен и брз 
                    пристап до информации за јавните услуги, потребните документи и процедури за 
                    различни животни настани. Нашата цел е да ја намалиме бирократијата и да 
                    го олесниме секојдневниот живот на граѓаните.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="group relative overflow-hidden bg-gradient-to-br from-primary/5 to-primary/10 border-primary/20 hover:border-primary/40 transition-all duration-300">
                <CardContent className="p-8">
                  ...
                  <h2 className="text-2xl font-bold text-foreground mb-4">Наша визија</h2>
                  <p className="text-muted-foreground leading-relaxed">
                    Дигитализација на јавната администрација која ќе го подобри квалитетот на 
                    услугите и ќе ја зголеми транспарентноста во работата на државните институции.
                    Визијата ни е секој граѓанин да може да пристапи до сите јавни услуги од 
        ...
        <section className="py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Наши вредности</h2>
              <p className="text-muted-foreground max-w-xl mx-auto text-lg">
                Принципите кои не водат во секојдневната работа
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="group bg-card hover:bg-card/80 border-border hover:border-primary/30 transition-all duration-300">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-foreground mb-2">Граѓаните прво</h3>
              ...
              <Card className="group bg-card hover:bg-card/80 border-border hover:border-primary/30 transition-all duration-300">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-foreground mb-2">Транспарентност</h3>
                  <p className="text-sm text-muted-foreground">
              ...
              <Card className="group bg-card hover:bg-card/80 border-border hover:border-primary/30 transition-all duration-300">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-foreground mb-2">Иновација</h3>
                  <p className="text-sm text-muted-foreground">
              ...
              <Card className="group bg-card hover:bg-card/80 border-border hover:border-primary/30 transition-all duration-300">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-foreground mb-2">Посветеност</h3>
                  <p className="text-sm text-muted-foreground">
